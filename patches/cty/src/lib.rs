...
#[cfg(any(target_arch = "mips",
          ...
          target_arch = "nvptx64",
          target_arch = "xtensa",
          // see https://loongson.github.io/LoongArch-Documentation/LoongArch-ELF-ABI-CN.html
          // the `char` datatype is signed by default for all base ABI types of LoongArch
